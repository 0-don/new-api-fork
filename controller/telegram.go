...
func TelegramBind(c *gin.Context) {
	if !common.TelegramOAuthEnabled {
		c.JSON(200, dto.ApiResponse{Message: common.TranslateMessage(c, "option.telegram_required")})
		return
	}
	...
	if model.IsTelegramIdAlreadyTaken(telegramId) {
		c.JSON(200, dto.ApiResponse{Message: common.TranslateMessage(c, "oauth.already_bound")})
		return
	}

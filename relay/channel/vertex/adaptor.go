...
func (a *Adaptor) GetRequestURL(info *relaycommon.RelayInfo) (string, error) {
	...
	return "", errors.New(i18n.Translate("relay.unsupported_request_mode_80a2"))
}
...
func (a *Adaptor) ConvertOpenAIRequest(c *gin.Context, info *relaycommon.RelayInfo, request *dto.GeneralOpenAIRequest) (any, error) {
	if request == nil {
		return nil, errors.New(i18n.Translate("relay.request_is_nil_fd31"))
	}
	...
	return nil, errors.New(i18n.Translate("relay.unsupported_request_mode_72bd"))
}

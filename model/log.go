...
func RecordErrorLog(c *gin.Context, userId int, channelId int, modelName string, tokenName string, content string, tokenId int, useTimeSeconds int,
	...
	logger.LogInfo(c, fmt.Sprintf(i18n.Translate("model.record_error_log_userid_channelid_modelname_tokenname"), userId, channelId, modelName, tokenName, common.LocalLogPreview(content)))
...
func RecordConsumeLog(c *gin.Context, userId int, params RecordConsumeLogParams) {
	...
	if common.DataExportEnabled {
		gopool.Go(func() {
			...
			LogQuotaData(userId, username, params.ModelName, params.Quota, common.GetTimestamp(), totalTokens)
		})
	}
}
...
func GetAllLogs(logType int, startTimestamp int64, endTimestamp int64, modelName string, username string, tokenName string, startIdx int, num int, channel int, group string, requestId string, upstreamRequestId string, subscriptionPlan string) (logs []*Log, total int64, err error) {
	var tx *gorm.DB
